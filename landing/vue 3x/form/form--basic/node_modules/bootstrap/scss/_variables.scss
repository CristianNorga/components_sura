...
// scss-docs-start icon-variables
$icon-bg:   black;
$icon-height: ($font-size-base + 0.1) * 2;
$icon-width:  ($font-size-base + 0.1) * 2;

$h1-icon: $font-size-base * 5.5 !default;
$h2-icon: $font-size-base * 4.4 !default;
$h3-icon: $font-size-base * 3.3 !default;
$h4-icon: $font-size-base * 2.2 !default;
$h5-icon: $font-size-base * 1.1 !default;
$h6-icon: $font-size-sm !default;
