Vue.component('form-sura', {
	...
	mounted: function () {
		...
		if (!this.ScForm.smartCaptureFormID)
		...
		<form  :id="'smartcapture-block-' + ScForm.gearID" class="smartcapture-content-wrapper container-fluid" novalidate="novalidate">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-6">
					<input-sura_select-mple :p-search="true" :icons="basicIcons" :p-required="true" p-name="nombre" :items="lists.names" :verifying="state.verifying" @status="getStatus"></input-sura_select-mple>
				</div>
